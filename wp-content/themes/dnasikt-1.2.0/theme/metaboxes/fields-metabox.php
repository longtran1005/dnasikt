...
class FieldsMetabox {
	...
	public function save( $post_id ) {
		...
		$conversation_closed = $_POST['conversation_closed'];
    ...
    update_post_meta( $post_id, '_conversation_closed', $conversation_closed );
	}
	...
	public function render_meta_box_content( $post ) {
		...
		$conversation_closed = get_post_meta( $post->ID, '_conversation_closed', true );
...
<hr>
    <input type="checkbox" id="conversation_closed" name="conversation_closed" <?php echo esc_attr( $conversation_closed )=='on' ? 'checked' : '' ?>/> Debatten är avslutad
