	...
	<?php if($is_new_conversation): ?>
		...
		<div class="form add-persons">
			<div class="form-section persons-content">
				<p class="tip ff-sans-light"><strong class="ff-sans-bold">Tips!</strong> Här lägger du till tips på en eller flera personer som du vill ska svara på din åsikt.</p>
				<p class="tip ff-sans-light"><strong class="ff-sans-bold">Obs!</strong> Läsarna av debatten kommer sedan kunna skicka in egna förslag på ytterligare personer som de vill ska svara.</p>
