	...
	<head>
		...
		<script>
		    ...
		    if( window.innerWidth < 767 ) {
	    		window.Fusion.mediaZone = "bns.mobil.dn.asikt.0.0.etta";
	        	window.Fusion.layout = "dn_m_asikt";
	    	}
	    	else {
	    		window.Fusion.mediaZone = "bns.desktop.dn.asikt.0.0.etta";

	        	window.Fusion.layout = (postType == "asikt") ? "dn_asikt_artikel" : "dn_asikt";
	    	}
            <?php error_log('POST TYPE: ' . get_post_type()); ?>
